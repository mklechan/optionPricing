...
double EuroPutFDCrankNichLN( double S, double K, double r, double sigma, double time, int no_S_steps, int no_t_steps) {
    int N=no_t_steps;
    ...
    cout << endl;
    ofstream myfile; myfile.precision(15); myfile.open("cranknich.csv");
