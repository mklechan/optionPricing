...
double AmPutFDImplicit( double S, double K, double r, double sigma, double time, int no_S_steps, int no_t_steps) {
    ...
    ofstream myfile; myfile.precision(15); myfile.open("amputimplicit.csv");
